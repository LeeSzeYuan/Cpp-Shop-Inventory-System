...
ifstream inp;		//write data into file
ofstream out;		//display data from file to screen
fstream file;		//write in and display data depends on condition
...
void StockInfo::Withdraw()
{
    ...
    while(file) //while not the end of the file
    {
...
void StockInfo::Refill()
{
    ...
    while(file) //not the end of the file
    {
